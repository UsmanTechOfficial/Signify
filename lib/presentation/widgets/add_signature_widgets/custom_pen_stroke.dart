...
class CustomPenStroke extends StatelessWidget {
  ...
  const CustomPenStroke({super.key, required this.selectedStroke, required this.penStroke});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      color: penStroke.index == selectedStroke ? color.primary : AppStyle.transparent,
      child: Padding(
        padding: const EdgeInsets.all(5.0),
        child: Icon(
          Icons.line_axis,
          color: penStroke.index == selectedStroke ? color.surface : color.onSurface,
