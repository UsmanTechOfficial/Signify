...
import 'package:dyno_sign/presentation/pop_up/request_signature/request_sign_email_detail/req_sign_email_detail_view.dart';
...
class ReqSignAssignFieldsView extends StatelessWidget {
            ...
            BlocBuilder<ReqSignAssignFieldsBloc, ReqSignAssignFieldsState>(
              ...
              builder: (context, state) {
                if (state is DocumentPreviewLoading) {
                  ...
                  return Image.memory(selectedPdfFileList[state.index].bytes);
                }
