...
import 'package:dyno_sign/presentation/pop_up/add_templates/add_template_assign_fields/add_template_assign_fields_view.dart';
import 'package:flutter/material.dart';

import '../../../../domain/consts/consts.dart';
import '../../../widgets/widgets.dart';

class AddTemplateEmailDetailView extends StatelessWidget {
  const AddTemplateEmailDetailView({super.key});
            ...
            children: [
              Align(
                ...
                child: CustomOutlinedTextButton(
                  onPressed: () {
                    Go.to(const AddTemplateAssignFieldsView());
                  },
                  text: 'Send',
