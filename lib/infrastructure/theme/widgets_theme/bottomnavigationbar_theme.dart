...
BottomNavigationBarThemeData get bottomNavigationBarTheme => BottomNavigationBarThemeData(
    ...
    selectedIconTheme: IconThemeData(
      color: colorSchemeLight.primary, // Use the primary color for selected icons
    ),
    unselectedIconTheme: IconThemeData(
      color: colorSchemeLight.onSurface
          .withOpacity(0.60), // Use the onSurface color with opacity for unselected icons
    ),
    selectedLabelStyle: TextStyle(
      color: colorSchemeLight.primary, // Use the primary color for selected labels
    ),
    unselectedLabelStyle: TextStyle(
      color: colorSchemeLight.onSurface
          .withOpacity(0.60), // Use the onSurface color with opacity for unselected labels
    ));

BottomNavigationBarThemeData get darkBottomNavigationBarTheme => BottomNavigationBarThemeData(
    ...
    // Use the onSurface color with opacity for unselected items
    selectedIconTheme: IconThemeData(
      color: colorSchemeDark.primary, // Use the primary color for selected icons
    ),
    unselectedIconTheme: IconThemeData(
    ...
    selectedLabelStyle: TextStyle(
      color: colorSchemeDark.primary, // Use the primary color for selected labels
    ),
    unselectedLabelStyle: TextStyle(
      color: colorSchemeDark.onSurface
          .withOpacity(0.60), // Use the onSurface color with opacity for unselected labels
